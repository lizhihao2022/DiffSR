...
#         dim = model_args['dim']
#         cond_dim = model_args.get('cond_dim', None)
#         out_dim = model_args.get('out_dim', None)
#         dim_mults = model_args.get('dim_mults', (1, 2, 4, 8))
#         channels = model_args.get('channels', 6)
#         attn_heads = model_args.get('attn_heads', 4)
#         attn_dim_head = model_args.get('attn_dim_head', 32)
#         use_bert_text_cond = model_args.get('use_bert_text_cond', False)
#         init_dim = model_args.get('init_dim', None)
#         init_kernel_size = model_args.get('init_kernel_size', 7)
#         use_sparse_linear_attn = model_args.get('use_sparse_linear_attn', True)
#         block_type = model_args.get('block_type', 'resnet')
#         resnet_groups = model_args.get('resnet_groups', 8)
